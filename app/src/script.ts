        ...
        callbacks.push(() => {
            fish.move(
                new THREE.Vector3(
                    ...
                    NOISE.perlin2(
                        y1 + time.value * wander * sy1,
                        y2 + time.value * wander * sy2
                    ) * speed,
                    NOISE.perlin2(
